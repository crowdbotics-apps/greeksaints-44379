"""
Django settings for greeksaints_44379 project.
...
ROOT_URLCONF = 'greeksaints_44379.urls'
...
WSGI_APPLICATION = 'greeksaints_44379.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "greeksaints_44379 API",
    "DESCRIPTION": "API documentation for greeksaints_44379 App",
    "VERSION": "v1",
}
